...
function Consultations() {
  ...
  return <div className="min-h-dvh">
    ...
    <main id="main" tabIndex={-1} className="mx-auto max-w-4xl px-5 pb-16 pt-12 sm:pt-16">
      ...
      {returnRef.current?.result === "cancelled" && <div className="mb-8 rounded-3xl border border-line bg-card p-5 text-base text-stone">No problem — nothing was charged. You can come back whenever you’re ready.</div>}
