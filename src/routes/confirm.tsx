...
function Confirm(){
  ...
  return <main id="main" tabIndex={-1} className="mx-auto flex min-h-dvh max-w-lg flex-col justify-center px-5 py-12"><a href="/" className="flex items-center gap-2 font-display text-2xl font-semibold text-forest"><img src="/logo-bys.svg" alt="" aria-hidden="true" className="h-7 w-7" />Before You Send<span className="text-forest-soft">.</span></a><div className="mt-12 rounded-[2rem] border border-line bg-card p-7">
