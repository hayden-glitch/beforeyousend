...
function Dashboard(){
 ...
 return <div className="min-h-dvh pb-24"><header className="sticky top-0 z-20 min-h-16 border-b border-line/70 bg-cream/95 backdrop-blur"><div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-5 py-2"><a href="/" className="inline-flex min-h-11 items-center font-display text-xl font-semibold text-forest sm:text-2xl">Before You Send<span className="text-forest-soft">.</span></a><UserMenu user={user} tier={tier} context="dashboard" /></div></header>
