...
function Dashboard(){
 ...
 async function buyTopUp(){setNotice("");track("quota_cta_click",{});recordSurface("quota_cta");const outcome=await runCheckout({plan:"topup",source:"home",onError:(m)=>setNotice(m||"Checkout is not available right now.")});if(outcome.state==="opening"&&outcome.url)location.href=outcome.url;}
