...
import { IconAction, IconAnalyze, IconArrowDown, IconArrowUp, IconBook, IconClose, IconDownload, IconGavel, IconLog, IconOrganizer, IconPlus, IconReview, IconTimeline } from "~/components/icons";
...
function Dashboard(){
 ...
 useEffect(()=>{
   ...
   const apply=async(r:Response):Promise<"ok"|"retry"|"gone">=>{
     ...
     setUser({...(j.user||{}),quota:j.quota,organizerTrial:j.organizerTrial,organizerFiles:j.organizerFiles});
     loadSaved();
     return "ok";
   };
