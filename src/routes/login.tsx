...
function Login(){
  ...
  // Passwordless sign-in is NOT available yet (email is not integrated — a real
  // fact, per the owner's auto-logout report 75fa1a07): the old "Email me a
  // sign-in link" button hit a dead 503 on the server. The honest nudge is
  // below the form instead — set a password and any browser can sign you back
  // in. (Passwordless accounts get the "Set a password" card on the dashboard.)
