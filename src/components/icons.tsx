...
export function IconTheme({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 3a9 9 0 1 1 0 18V3z" fill="currentColor" stroke="none" />
      <circle cx="12" cy="12" r="9" />
    </svg>
  );
}

export function IconLeaf({ className: _className }: IconProps) {
  return base(
    <>
      <path d="M5 19C5 9.5 11.5 4.5 20 4.5c0 8.5-5 14.5-15 14.5z" />
      <path d="M5 19c3.5-6 7.5-9.5 12-10.5" />
    </>,
  );
}
...
export function IconSun({ className: _className }: IconProps) {
  return base(
    <>
